# Anima Trainer — Ribbity Fork
   
   Fork with added features:
   - Training queue
   - LoRA sync to ComfyUI
   - Output folder precheck
   - Per-job progress bars
   
   Original: https://github.com/gazingstars123/Anima-Standalone-Trainer
